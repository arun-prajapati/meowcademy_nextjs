  ...
  return (
   <>
    <div className="pt-24">
        ...
        <div className="container mt-8 flex flex-col gap-6 break-words">
          <p>
          ...
          <p className="font-bold">When do we collect information?</p>
          <p>
            We collect information from you when you register on our site, place
            an order, subscribe to a newsletter, fill out a form, Use Live Chat
          ...
          <p>
            We do not use an SSL certificate because: we haven&apos;t applied
            for one
          </p>
          ...
          <p>
            ...
            emails, you can email us at cscat@meowcademy.com and we will
          ...
          <Link href="https://meowcademy.com/" className="text-blue-600">
            meowcademy.com
          </Link>
          <p>Woods Square Tower 1 #06-80 Spore 737715</p>
