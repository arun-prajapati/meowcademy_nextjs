                        ...
                        <div>
                          {location?.location_time?.map((time, index) => (
                            <p className="mt-2" key={index}>
                              {time.day}:{" "}
                              <span>
                                {formatTime(time.start_time, time.end_time)}
                              </span>
                            </p>
                          ))}

                          <p className="font-bold text-primaryBlue mt-3">
                            {" "}
                            Public Holidays: open as per weekend hours
                          </p>
                        </div>
                      </details>
                    </div>
                  </div>
                  <a href="https://wa.me/+6587713358" className="mt-5 block">
                    <button className="button flex gap-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="25"
